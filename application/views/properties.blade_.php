                ...
                <div class="popup-slider-text">
                    <div class="inner-slider-text">
                        ...
                        <div class="content-text">
                            ...
                            <button class="btn btn-link pl-0" id="reportProperty" style="text-decoration: none;color: #2d2a2a" data-propertyid="" onclick="reportProperty(this)"><i class="fa fa-comments" aria-hidden="true"></i> Report
                                Property</button>
                            @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" id="other_reason_area" style="display: none;">
                        <textarea class="form-control" name="other_reason" id="other_reason" cols="30" rows="5" placeholder="Enter Reason"></textarea>
                    </div>
                </div>
...
@push('scripts')
<script>
    var csrf_name = '<?php $CI = &get_instance();
        ...
        var initMap = (latLng = [40.71427, -74.00597]) => {
            try {
                ...
                setTimeout(function() {
                    ...
                    window.mapPicker.setView(latLng, 15);
                }, 1000);
                // console.log('if');
            } catch (err) {
                // console.log('else');
