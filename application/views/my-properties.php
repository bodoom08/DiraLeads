                                                                    ...
                                                                    <div class="tc_content">
                                                                        ...
                                                                        <?php if ($value['is_annual'] == 'true') { ?>
                                                                            <ul class="prop_details <?php echo ($value['status'] == 'inactive' ? 'resume_prop' : ''); ?>">
                                                                                ...
                                                                                <li class="list-inline-item"><a href="#"><span> <i class="fa fa-money" aria-hidden="true"></i></span><?php echo $value['days_price'] ? 'Daily: $' . $value['days_price'] . ' ' : '' ?><?php echo $value['weekend_price'] ? 'Weekend: $' . $value['weekend_price'] . ' ' : '' ?><?php echo $value['weekly_price'] ? 'Weekly: $' . $value['weekly_price'] . ' ' : '' ?><?php echo $value['monthly_price'] ? 'Monthly: $' . $value['monthly_price'] : '' ?></a></li>
