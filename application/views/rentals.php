        ...
        function addMarkers() {
            streets.forEach((street) => {
                ...
                newMarker.addListener('mouseover', function(event) {
                    ...
                    else document.getElementById('property-overview-image').src = '/uploads/diraleads-logo.svg';
                    document.getElementById('property-overview-capacity').innerHTML = `
                        <span>
