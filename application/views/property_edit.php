                ...
                <div class="content-area5">
                    <div class="dashboard-content">
                        <div class="dashboard-list">
                            ...
                            <h3 class="heading">Property Details - <span style="font-size: 13px;"><?php echo 'ID: '.$property_details['id'] ?></h3>
                            <div class="dashboard-message contact-2 bdr clearfix">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <?php echo form_open_multipart('my_properties/update', 'id="updateForm" class=""'); ?>
                                            ...
                                            <div class="clearfix">
                                                <?php foreach($packagenames as $key => $pack): ?>
                                                    ...
                                                    <label class="radio-main"> <?php echo $caption; ?>
                                                        <input type="radio" <?php echo ($property_details['for'] == strtolower(($pack->name))) ? 'checked="checked"' : '' ?> name="property" value="<?php echo strtolower($pack->name); ?>">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 d-none">
                                                                <div class="form-group">
                                                                    <input type="text" placeholder="House No" class="form-control" name="house_no" value="<?php echo $property_details['house_number'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
