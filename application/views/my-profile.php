                                                        ...
                                                        <div class="form-group number">
                                                            ...
                                                            <div class="row">
                                                                <div class="custom-control custom-checkbox col-md-4">
                                                                    <input type="checkbox" <?php if (isset($languag) && in_array('English', $languag)) {
                                                                                                echo 'checked';
                                                                                            } ?> class="custom-control-input" id="customCheck1" disabled>
                                                                    <label class="custom-control-label" for="customCheck1">English</label>
                                                                </div>
                                                                <div class="custom-control custom-checkbox col-md-4">
                                                                    <input type="checkbox" <?php if (isset($languag) && in_array('Yiddish', $languag)) {
                                                                                                echo 'checked';
                                                                                            } ?> class="custom-control-input" id="customCheck2" disabled>
                                                                    <label class="custom-control-label" for="customCheck2">Yiddish</label>
                                                                </div>
                                                                <div class="custom-control custom-checkbox col-md-4">
                                                                    <input type="checkbox" <?php if (isset($languag) && in_array('Hebrew', $languag)) {
                                                                                                echo 'checked';
                                                                                            } ?> class="custom-control-input" id="customCheck3" disabled>
                                                                            ...
                                                                            <div class="form-group number">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" name="language[]" value="English" <?php if (in_array('English', $languag)) {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?> class="custom-control-input" id="customCheck1">
                                                                                        <label class="custom-control-label" for="customCheck1">English</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" name="language[]" value="Yiddish" <?php if (in_array('Yiddish', $languag)) {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?> class="custom-control-input" id="customCheck2">
                                                                                        <label class="custom-control-label" for="customCheck2">Yiddish</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" name="language[]" value="Hebrew" <?php if (in_array('Hebrew', $languag)) {
                                                                                                                                                    echo 'checked';
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCPhDpAUyER52TsCsLFNOOxT_l5-y7e78A&libraries=places&callback=initMap" async defer></script>
