...
@section('content')                             
    <div class="service-sec">
                ...
                <div class="col-lg-12 col-12">
                    <div class="tabbing-sec" id="tile-1">
                        <div class="heading-sec">
                            ...
                            <h2>Working with the Reality</h2>
                            <div class="home-icon">
                        ...
                        <ul class="nav nav-pills mb-3" id="ser-tab" role="tablist">
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" id="ser-home-tab" data-toggle="pill" href="#ser-home" role="tab" aria-controls="ser-home" aria-selected="true">Rent</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="ser-profile-tab" data-toggle="pill" href="#ser-profile" role="tab" aria-controls="ser-profile" aria-selected="false">Rent Out</a>
                          </li>
                        </ul>
        ...
        <div class="container-fluid">
           ...
           @endif
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="button-sec">
                        <a href="/properties">Explore All Neighborhoods</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="sec">
                        <h2>looking to go away?</h2>
                        <p>Let us know your desires, and we will update you with rentals to your preferences.</p>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="button-sec">
                    ...
                    @endif
                        <a href="{{ $href }}" target="_blank">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="details">
    <p><span>Phone</span>+12 345 678 971</p>
    <p><span>Email</span>info@yourmail.com</p>
    </div>
    </div>
    </div>
            ...
            $.ajax({
                ...
                success: function(arg) {
                    if(arg.success == false) {                        
                        ...
                        setTimeout(function(){  $('#frmerror').html('').hide(); }, 3000);
