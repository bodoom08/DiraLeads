        ...
        <header class="main-header header-transparent sticky-header">
            <nav class="navbar navbar-expand-lg demo-2">
                <div class="container navbar-container">
                    ...
                    <img style="width: 146px;" src="{{ site_url() }}uploads/{{ CFG_LOGO }}" alt="logo">
                    </a>
                    ...
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav offcanvas-navbar position-relative">
                            <div class="dropdown btns">
                                    <a class="dropdown-toggle" data-toggle="dropdown" style="color: #fc6d6d !important; font-weight: 600;">
                                        <img src="/assets/img/avatar/user.png" width="20" alt="avatar">
                                            Hi, {{ explode(' ', $_SESSION['name'])[0] }}
                                    </a>
                                    <div class="dropdown-menu" style="float:right; color:#000 !important;">
                                        <a class="dropdown-item" href="<?php echo site_url('dashboard'); ?>" style="color: #000 !important;">Dashboard</a>
                                        <a class="dropdown-item" href="<?php echo site_url('my_properties'); ?>"style="color: #000 !important;">My Properties</a>
                                        <a class="dropdown-item" href="<?php echo site_url('subscription/user'); ?>"style="color: #000 !important;">My Subscriptions</a>
                                        <a class="dropdown-item" href="<?php echo site_url('profile'); ?>"style="color: #000 !important;">My profile</a>
                                        <a class="dropdown-item" href="<?php echo site_url('login/logout'); ?>"style="color: #000 !important;">Logout</a>
                                    </div>
                            </div>
                            <!-- <li class="nav-item ">
