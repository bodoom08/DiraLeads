...
<html lang="en">
    ...
    <body class="@if ( isset($slug)){{$slug}}@endif">
        ...
        <nav class="navbar navbar-expand-xl navbar-light container-fluid">
          <a class="navbar-brand" href="{{ site_url() }}"><img src="{{ site_url() }}uploads/{{ CFG_LOGO }}"></a>
     ...
     <div class="footer-sec">
        <div class="container-fluid">
            <div class="row">
              ...
              <input type="hidden" class="loggedId" value="{{$_SESSION['id']}}">
...
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
  ...
  var width = $(this).parent().width();
    $("#tile-1 .sliderrr").css({"left":+ position.left,"width":width});
});
var actWidth = $("#tile-1 .nav-pills").find(".active").parent("li").width();
var actPosition = $("#tile-1 .nav-pills .active").position();
$("#tile-1 .sliderrr").css({"left":+ actPosition.left,"width": actWidth});
    </script>
    </body>
