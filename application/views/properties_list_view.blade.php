               ...
               <div class="item">
                     <div class="feat_property slider_property">
                       ...
                       <div id="carouselExampleControls{{$j}}" class="carousel slide" data-interval="false">
                        ...
                        <img class="img-whp" src="<?php echo site_url('/'); ?>uploads/{{$image['path']}}"
                        alt="properties" />
                        </div>
                        @endif
                        @endforeach
                        ...
                        @else
                        <img class="img-whp" src="<?php echo site_url('/'); ?>uploads/diraleads-logo.svg"
                        alt="properties" />
                        @endif
...
<nav aria-label="Page navigation example">
   <ul class="pagination justify-content-center" style="margin: 0 auto; display: flex; margin-bottom:30px;">
      ...
      <li class="page-item"><a class="page-link"
            href="?page=<?php echo $i; ?><?php echo ($query_string != '') ? '&'.$query_string:''; ?>"><?php echo $i; ?></a>
      </li>
      <?php endif; ?>
      <?php endfor; ?>
