...
<link rel="stylesheet" href="<?php echo site_url('assets/css/bootstrap-multiselect.css'); ?>">
    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <?php echo form_close(); ?>
                <form action="<?php echo site_url('profile/update_package_area_pref'); ?>" method="post" name="profile_time_pref" style="margin-left: 30px;" class="">
                    <?php
                        // echo '<pre>';
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="send-btn mb-3">
                                <button type="submit" class="btn btn-sm button-theme">Edit Area Preference</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    $('form[name="profile_time_pref"]').ajaxForm({
        ...
        success: function(arg) {
            ...
            if (arg.type == 'success') {
                toastr['success']('Pref Updated, Please wait...');
                setTimeout(() => {
                    window.location.href = '<?php echo site_url('subscription/user'); ?>';
                }, 2000);
            }
        }
    });
