                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="basic_information">
                                            ...
                                            <div class="clearfix">
                                                <?php foreach($packagenames as $key => $pack): ?>
                                                    <?php
                                                        $caption = ucwords(($pack->name == 'Sale') ? 'Sell' : $pack->name);
                                                    ?>
                                                    <label class="radio-main"> <?php echo $caption; ?>
                                                        <input type="radio" <?php echo ($key == 0) ? 'checked="checked"' : '' ?> name="property" value="<?php echo strtolower($pack->name); ?>">
                                            ...
                                            <div class="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="input-group transparent-input-group curve mb-1">
                                                                    ...
                                                                    <input type="text" placeholder="Enter Street Address" class="form-control" name="street" id="autocomplete_area" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 ">
                                                                <div class="form-group">
                                                            ...
                                                            <!-- <div class="col-md-6 d-none">
                                                                <div class="form-group">
                                                                    <input type="text" placeholder="Date Available" class="form-control datepicker" id="available_date"  name="available_date" required>
                                                                    <code><small>
                                                    ...
                                                    <div class="row" style="display: none;">
                                                        <div class="col-lg-12">
                                                            <div class="input-group transparent-input-group curve mb-1">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Search Places..." id="autocomplete_area" style="width:auto;"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h4 class="inner-title mb-3 ">How People can Contact me ?</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h4 class="inner-title mb-3 ">Day of Week</h4>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                ...
                                                <div class="upload_media mt-2">
                                                    <h4 class="inner-title mb-3">Time of Day</h4>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
...
<script>
    $('#listingForm').ajaxForm({
        ...
        success: function(arg) {                               
            ...
            if (arg.type == 'success') {
                window.location.href = '<?php echo site_url('my_properties'); ?>';
            }
        }
    });
</script>
