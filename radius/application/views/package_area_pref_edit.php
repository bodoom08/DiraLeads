    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <?php echo form_close(); ?>
                <form action="<?php echo site_url('pricing/update_package_area_pref'); ?>" method="post" name="profile_time_pref" style="margin-left: 30px;" class="">
                    <?php
                        // echo '<pre>';
