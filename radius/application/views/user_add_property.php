...
$this->load->view('common/top', [
    'title' => 'Property Add | User : ' . $user->name
]);
?>
                ...
                <div class="content-area5">
                    <div class="dashboard-content">
                        <div class="dashboard-list">
                            <h3 class="heading">Property Add of <?php echo $user->name . ' (' . $user->email . ')'; ?></h3>
                            <div class="dashboard-message contact-2 bdr clearfix">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <?php echo form_open_multipart('users/property_add', 'id="listingForm" class=""'); ?>
                                        <div class="basic_information">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="upload_media mt-2">
                                                    ...
                                                    <div id="map-picker" style="height: 600px;"></div>
...
<script>
    $('#listingForm').ajaxForm({
        ...
        success: function(arg) {
            ...
            if (arg.type == 'success') {
                window.location.href = '<?php echo site_url('users?email=' . $_GET['email']); ?>';
            }
        }
    });
</script>
